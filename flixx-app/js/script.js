const global = {
  ...
  api: { 
    apiKey: '8c8ad7a7d0992307b15652dccb16acba',
...
async function displayMovieDetails() {
  ...
  <div class="details-bottom">
    <h2>Movie Info</h2>
    <ul>
      <li><span class="text-secondary">Budget:</span> $${addCommasToNumber(String(movie.budget))}</li>
      <li><span class="text-secondary">Revenue:</span> $${addCommasToNumber(String(movie.revenue))}</li>
...
async function search() {
  ...
  if (global.search.term !== '' && global.search.term !== null) {
    ...
    showAlert('Please enter a term', 'error');
  }
}
  ...
  results.forEach((slide) => {
    ...
    div.innerHTML = `  
        <a href="movie-details.html?id=${slide.id}">
          ${slide.poster_path ? `<img
            src="https://image.tmdb.org/t/p/w500${slide.poster_path} alt="${slide.title}" />` : `<img src="./images/no-image.jpg" alt="${slide.title}" />`}
        </a>
        <h4 class="swiper-rating">
          <i class="fas fa-star text-secondary"></i> ${Math.round(slide.vote_average * 10)/ 10} / 10
        </h4>`;
